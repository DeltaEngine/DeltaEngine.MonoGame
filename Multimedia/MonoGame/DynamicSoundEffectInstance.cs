...
{
	/// <summary>
	/// http://stackoverflow.com/questions/15959903/xna-monogame-dynamicsoundeffectinstance-buffer-already-full-exception
	/// </summary>
	public sealed class DynamicSoundEffectInstance : IDisposable
	{
		...
		{
			var size = (int)(duration.TotalMilliseconds * ((float)sampleRate / 1000.0f));
